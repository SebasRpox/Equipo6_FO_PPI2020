            ...
            <div className="all">
                <Navbar>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        <Navbar.Text>
                            En línea <img className= "config__img" src={Usuario} />
                        </Navbar.Text>
                    </Navbar.Collapse>
                </Navbar>
                ...
                <hr></hr>
                <div>
                <Link to="Ayuda"><img id="monda" className="icon ml-2 mr-2" src={Gestion} /></Link>
                Ayuda
                
                </div>
                <div>
                <Link to="Seguridad"><img className="icon ml-2 my-3" src={Seguridad} /></Link>
                Seguridad
                </div>
                <hr></hr>
                <div>
